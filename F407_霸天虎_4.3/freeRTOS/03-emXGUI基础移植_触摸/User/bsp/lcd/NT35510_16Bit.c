...
#define	LCD_RST_PIN	NT35510_RST_PORT,NT35510_RST_PIN
#define	LCD_BL_PIN	NT35510_BK_PORT,NT35510_BK_PIN
...
void	LCD_Init(void)
{
  ...
  gpio_init.GPIO_PuPd  = GPIO_PuPd_UP;//上拉
	...
	gpio_init.GPIO_Pin = NT35510_BK_PIN;
	GPIO_Init(NT35510_BK_PORT, &gpio_init); //初始化

	//PG11 - LCD_nRST:
	gpio_init.GPIO_Pin = NT35510_RST_PIN;
	GPIO_Init(NT35510_RST_PORT, &gpio_init); //初始化
